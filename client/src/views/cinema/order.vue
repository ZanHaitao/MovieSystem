...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleChange() {
                if (this.searchOrderId === '' && this.searchUserId === '' && this.searchMovieId === '') {
                    this.getData();
                    return;
                }
            },
            ...
            handleSearchOrderId() {
                ...
                this.loading = true;
                this.$api.getOrderFindById(this.searchOrderId, 'cinema').then(res => {
                    if (res) {
                        this.total = 1;
                        this.orderData = [res];
                        this.loading = false;
...
<style lang="scss">
    @import '@/assets/scss/cinema/order/order.scss';
</style>